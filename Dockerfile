...
COPY io.fabric8.tenant.che_workspace_migration-*-swarm.jar io.fabric8.tenant.che_workspace_migration-swarm.jar
...
CMD java -jar io.fabric8.tenant.che_workspace_migration-swarm.jar
